    ...
    <b-row>
      <b-col cols="12" lg="2">
        ...
        <b-input-group size="sm" style="margin-top:10px">
          ...
          <b-form-input class="customInput" style="cursor: text" :value="filter" v-on:input="onFilterUpdate"
                        :state="filterState" placeholder="Search ..."></b-form-input>
        </b-input-group>
      ...
      <b-col cols="12" lg="10" style="min-width:700px">
        ...
        <b-pagination size="sm" align="center" v-if="perPage > 0" :total-rows="totalRows" :per-page="perPage"
...
export default {
  ...
  methods: {
    query: async function () {
      ...
      this.line_ins = await this.$agent.p_mfa('ws_agent', 'lines_in')
      this.line_ins.unshift({name: "Any Line In"})
      this.line_outs = await this.$agent.p_mfa('ws_agent', 'lines_out')
