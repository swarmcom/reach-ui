...
<div style="min-height: 100%; padding-bottom: 60px">
  ...
  <b-nav v-if="auth" class="custom-b-nav" v-bind:class="{ 'pin-nav': isPinned }" tabs>
    ...
    <b-nav-item-dropdown>
      ...
      <b-dropdown-item v-if="!$agent.vm.layoutSM.isActiveAM" @click="onWidgetAMChange(true)">Add Agent Manager</b-dropdown-item>
      <b-dropdown-item v-if="$agent.vm.layoutSM.isActiveAM" @click="onWidgetAMChange(false)">Remove Agent Manager</b-dropdown-item>
      <b-dropdown-item v-if="!$agent.vm.layoutSM.isActiveQM" @click="onWidgetQMChange(true)">Add Queue Manager</b-dropdown-item>
      <b-dropdown-item v-if="$agent.vm.layoutSM.isActiveQM" @click="onWidgetQMChange(false)">Remove Queue Manager</b-dropdown-item>
    </b-nav-item-dropdown>
