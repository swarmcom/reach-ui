...
<div class="container">
  ...
  <div v-for="release of releases" class="form-row" style="margin-top: 5px">
    <div class="col-1">
      <button @click="del(release.id)" class="btn btn-sm btn-outline-danger"><icon name="minus" class="align-middle" scale="1"></icon></button>
    </div>
    <div class="col-4">
  ...
  <div class="form-row" style="margin-top: 5px">
    <div class="col-1">
      <button @click="add" class="btn btn-sm btn-outline-secondary"><icon name="plus" class="align-middle" scale="1"></icon></button>
    </div>
    <div class="col-4">
