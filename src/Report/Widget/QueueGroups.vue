...
<autocomplete v-model="group" :query="query" placeholder="Queue group..."></autocomplete>
...
export default {
  name: 'report-widget-queue-groups',
  ...
  methods: {
    query (text) {
      return this.$agent.p_mfa('ws_agent', 'suggest', ['queue_group', text])
    },
    remove (group) {
    ...
    get: async function (id) {
      let entity = await this.$agent.p_mfa('ws_agent', 'entity', ['queue_group', id])
