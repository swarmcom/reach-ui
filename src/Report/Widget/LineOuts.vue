...
<autocomplete v-model="line_in" :query="query" placeholder="Line Out..."></autocomplete>
...
export default {
  ...
  methods: {
    query (text) {
      return this.$agent.p_mfa('ws_agent', 'suggest', ['line_out', text])
    },
    remove (line) {
    ...
    get: async function (id) {
      let entity = await this.$agent.p_mfa('ws_agent', 'entity', ['line_out', id])
