<template>
	<b-row style="padding: 0; margin: 0">
		<b-col style="padding: 0; margin: 0">
			<div>From:</div>
			<widget-date :value="date_start" @input="onFromChange" placeholder="Start date" :initValue="init_start" style="padding-bottom: 10px"></widget-date>
			<div>To:</div>
			<widget-date v-model="date_end" placeholder="End date" :initValue="init_end" style="padding-bottom: 30px"></widget-date>
